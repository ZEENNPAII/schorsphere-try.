-- PostgreSQL Database Schema for ScholarSphere
...
-- Application Remarks table (provider remarks/reviews for applications)
...
-- Scholarship Application Files table (links applications with credential files)
...
VALUES (
    ...
    '00000000',
    '1990-01-01',
    'pbkdf2:sha256:600000$YourSecretKey$hash_here',
    'admin',
    TRUE,
    CURRENT_TIMESTAMP
)
...
-- The actual hash will be generated by the Python script.
-- To create admin user with proper password hash, use: python setup_postgresql.py
